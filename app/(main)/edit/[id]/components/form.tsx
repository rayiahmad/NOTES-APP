...
import { updateCatatan } from "../action"; // Adjust the import path
...
interface FormProps {
  ...
  initialValues: FormValue; // Ensure this matches
}

const FormEdit = ({ id, initialValues }: FormProps) => {
  ...
  const form = useFormik<FormValue>({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        await updateCatatan(id, values.title, values.body);
